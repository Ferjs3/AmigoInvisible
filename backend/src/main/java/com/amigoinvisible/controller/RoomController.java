...
public class RoomController {
    ...
    @PatchMapping("/{id}")
    public ResponseEntity<RoomDetailResponse> update(@PathVariable Long id, @Valid @RequestBody UpdateRoomRequest request) {
        return ResponseEntity.ok(roomService.updateRoom(currentUser.get(), id, request));
    }
